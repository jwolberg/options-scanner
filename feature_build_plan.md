...
Acceptance criteria:
- card header shows opportunity tier and score
- card keeps `call_flow.regime`
- card adds `trade_recommendation.regime_label` as a separate badge for gamma regime
- card surfaces `direction`, `trade_type`, and `trade_bias`
